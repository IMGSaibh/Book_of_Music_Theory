...
Grundsätzlich betrachten wir die Tonleitern in steigender oder fallender Reihenfolge. Wir erkennen, dass bestimmte Töne zwar verschieden geschrieben werden, jedoch gleich klingen, ein \textbf{Cis} klingt wie ein \textbf{Des}. Sie dir dazu mal Halbtonschritt 1 in der Tabelle \ref{tab:TonstufenSteigend} an und in der Tabelle \ref{tab:TonstufenFallend} den Halbtonschritt 11. Hauptsächlich hat das etwas mit dem Vorzeichen (Versetzungszeichen) zu tun. Die hier erstmal nicht weiter beachten werden sollen.
...
Wir fassen alle einzelnen Töne noch einmal zusammen, um einen besseren Überblick zu bekommen welche der Töne gleich klingen aber 2 Bezeichnungen haben. Diese Töne werden im Übrigen enharmonische Töne genannt. In der oberen Zeile lesen wir die Töne steigend (C, D, E, usw.) und hängen somit ein -is- an. Wird wie in der unteren Zeile fallend gelesen (C, H, B, A, usw.), wird ein -es- angehangen. Aus A wird jedoch As und aus H wird B!  

\begin{table}[H]
    \caption{Töne und Halbtöne}
    \begin{tabularx}{\textwidth}{|*{12}{>{\footnotesize}X|}}
    \hline
    \cellcolor{red!25}C/His & \cellcolor{yellow!25}Cis & D & \cellcolor{green!25}Dis & E & \cellcolor{red!25}Eis/F & \cellcolor{gray!25}Fis & G & \cellcolor{blue!25}Gis & A & \cellcolor{orange!25}Ais & H \\ \hline
    C & \cellcolor{red!25}H/Ces & \cellcolor{orange!25}B & A & \cellcolor{blue!25}As & G & \cellcolor{gray!25}Ges & F & E & \cellcolor{green!25}Es & D & \cellcolor{yellow!25}Des \\ \hline
    \end{tabularx}
\end{table}

Lass dich von den rot markierten Zellen nicht verwirren. Sie stehen für sich. Lesen wir steigend (also die obere Zeile) und sind beim H angekommen geht es von vorn los und somit ist C auch gleichzeitig ein His. Genauso wie beim lessen fallend H auch ein Ces ist. Auch zwischen E und F liegt nur ein Halbtonschritt, sodass Eis und F derselbe Ton ist. 
